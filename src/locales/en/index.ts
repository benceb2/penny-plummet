export default {
  ...
  "about": {
    ...
    "game": {
      ...
      "description": "Penny Plummet is a browser-based casino game that combines classic gambling games with modern web technologies. Try your luck at Blackjack or test your clicking speed in the Clicker mini-game!"
    },
    "technology": {
    ...
    "features": {
      ...
      "blackjack": {
        "title": "Blackjack",
        "description": "Master the art of 21 in this classic card game. Beat the dealer with strategic play, unlock achievements, and climb the leaderboards."
      },
      "roulette": {
        "title": "Roulette",
        "description": "Spin the wheel of fortune! Place your bets on numbers, colors, or combinations in this timeless casino favorite with progressive rewards."
      },
      "clicker": {
        "title": "Clicker Game",
        "description": "Click your way to riches! Build combos, unlock multipliers, and prestige for massive rewards in this addictive idle game."
      }
    }
  },
  "achievements": {
